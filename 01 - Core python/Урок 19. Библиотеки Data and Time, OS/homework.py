...
# user_birthday_date = input("Enter your birthday date in format YYYY-MM-DD: ")
# user_date = datetime.strptime(user_birthday_date, "%Y-%m-%d")
# result = today_date.year - user_date.year
# print(f"Your age is '{result}' years")
...
# from datetime import datetime
# today_date = datetime.today()
# user_date = input("Enter your meeting date in format YYYY-MM-DD: ")
# meeting_date = datetime.strptime(user_date, "%Y-%m-%d")
# result = meeting_date.day - today_date.day
# print(f"'{result}' days left to your meeting")
...
# date_format1 = datetime.strptime(date1, "%Y-%m-%d")
# date_format2 = datetime.strptime(date2, "%Y-%m-%d")
# if date_format1 > date_format2:
#     print(f"Your '{date1}' date is later")
# else:
#     print(f"Your '{date2}' date is later")
# Тема: Модуль os
...
# else:
#     print(f"example.txt has size: {info.st_size} bites")
...
# info1 = os.stat('example.txt')
# info2 = os.stat('inventory_copy.json')
#
# if info1.st_size == info2.st_size:
#     print("File size is equal!")
# elif info1.st_size > info2.st_size:
#     print("example.txt has bigger size")
# else:
#     print("inventory.json has bigger size")
