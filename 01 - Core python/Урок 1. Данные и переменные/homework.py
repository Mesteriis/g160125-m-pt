...
#     - высота                                           height = 2
#     - ширина                                           width = 1
#     - стоимость товара                                 prod_price = 2
#     - возраст                                          age = 30
#     - сообщение об ошибке                              print("Fail")
#     - сообщение об успехе                              print("Success")
#     - количество студентов                             stud_quantity = 35
#     - имя пользователя                                 user_name = "user"
#     - Средняя температура за день                      average_day_temp = 10
#     - Общий объем продаж за месяц                      gen_sales_vol = 10_000_000
#     - Количество просмотров видео                      video_watched_quantity = 50_000_000
#     - Электронный адрес пользователя                   user_email = "user@user.com"
#     - Количество доступных мест в аудитории            class_free_places = 0
#     - Максимальная грузоподъемность лифта              max_elev_weight = 350
#     - Процент выполнения задачи                        task_percent_status = 99
#     - Оценка пользователя после обслуживания           rate_service = 5
#     - Суммарное время ожидания в очереди               time_in_line = 600
#     - Число страниц в документе                        bookpages_quantity = 900
...
#
# Задание 12. Какой будет порядок выполнения операций 3 + 5 * 9 // 4 ** (2 - 1)?   = 48 // 16 = 3
#
...
#   Word 1: s1 | Word 2: s2                 s1 = "I"
#   Например, ввод:                         s2 = "love"
#   I love
#   Вывод:
#   Word 1: I | Word 2: love                print(s1, s2)
#
...
#     - [ ] такой команды не существует
#ок
# Задание 8. Напишите программу, которая принимает на вход два вещественных числа в одну стру через пробел
