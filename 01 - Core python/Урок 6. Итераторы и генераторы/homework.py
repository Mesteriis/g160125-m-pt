...
# print("числа от 1 до 1000, которые делятся на 7", numbers)
...
# lowels = "aeoiuy"
# letter_count = sum(1 for letter in some_string if letter in lowels)
# print(letter_count)
...
# numbers = [[x + y * 3 for x in range(20, 23)] for y in range(3)]
...
# sum_number = [sum(x) for x in numbers]
# print(sum_number)
...
# numbers_sort1 = sum(1 for x in matrix for num  in x if num % 2 == 0)
# numbers_sort2 = sum(1 for x in matrix for num  in x if num % 2 != 0)
#
# print(f"Количество четных и нечетных чисел в матрице:", numbers_sort1)
# print(f"Количество четных и нечетных чисел в матрице:", numbers_sort2)
...
# for num, row in enumerate(matrix, start=34):
#     print(f"min. = {min(row)}, max. = {max(row)}")
...
matrix1 = [[x + y * 3 for x in range(1,4)] for y in range(3)]
matrix2 = [[9 - (x + y * 3) for x in range(3)] for y in range(3)]
print(matrix1)
print(matrix2)
