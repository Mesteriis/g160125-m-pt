...
# def randomise_nums(nums):
#     random.shuffle(nums)
#     print(nums)
#
#     gnums = []
#     for _ in range(1, 10):
#         gnums.append(random.randint(1, 100))
#     return gnums
#
# nums = list(range(1,10))
# new_nums = randomise_nums(nums)
# print(new_nums)
...
#     int_part = int(num)
#     fact = math.factorial(int_part)
#     print(f"факториал полученного целого числа {int_part} -- {fact}")
#
# round_number(9.5)
...
# def randomise_nums():
#     ran_num = random.uniform(1.5, 10.5)
#     round_down = math.floor(ran_num)
#     round_up = math.ceil(ran_num)
#     print(f"Random num: {ran_num:.1f}")
