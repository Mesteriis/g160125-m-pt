...
#     student - количество студентов
#     username - имя пользователя
#     average_temp - Средняя температура за день
#     month_sales - Общий объем продаж за месяц
#     views - Количество просмотров видео
#     email - Электронный адрес пользователя
#     seats_available - Количество доступных мест в аудитории
#     max_lift_capacity - Максимальная грузоподъемность лифта
#     task_progress - Процент выполнения задачи
#     user_rrating - Оценка пользователя после обслуживания
...
#       1. a = 4 ** (2-1) 2. b = 5 * 9 3. c = b // a 4. c + 3
#
...
#   5
#
# Вводим число с клавиатуры и преобразуем его в целое
...
#print(f"Абсолютное значение: {abs(a)}")
#
