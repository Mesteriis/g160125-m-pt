...
class ComplexNumber:
    ...
    def __truediv__(self, other):
        if isinstance(other, ComplexNumber):
            debim = self.real**2 + self.imag**2
            real = (self.real * other.real + self.imag * other.imag) / debim
            imag = (self.real * other.imag - self.imag - other.real) / debim
            return ComplexNumber(real,imag)
        return NotImplemented
    ...
    def __call__(self, *args, **kwargs):
        print(f"ComplexNumber called with {self.real + self.imag}")
