...
#         print(f"Class Person __init__(student_id={self.student_id})")
#
...
#        print(f"Class vehicle __init(num_doors = {self.num_doors}")
#
#
...
#         print(f"Class vehicle __init(has_sidecar = {self.has_sidecar}")
#
