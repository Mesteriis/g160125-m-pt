...
class LanguageGame:
    ...
    def generate_options(self, correct_translation):
        ...
        for word in self.word_list:
            if len(options) >= 4:
                break
            translation = Translator.get_translation(word, "uk", self.target_lang)
...
if __name__ == "__main__":
    word_list = ["яблуко", "банан", "вишня", "собака", "кіт", "будинок", "авто", "дерево", "сонце", "місяць"]
    game = LanguageGame("uk", "en", word_list)
    game.play_game()
